...
public class AUTO_DoubleSweepBumpPartnerLeft implements Auto {
  private final PathPlannerPath sweepHalfMiddle;
  private final PathPlannerPath sweepAgain;

  public AUTO_DoubleSweepBumpPartnerLeft() {
    try {
      sweepHalfMiddle = Auto.getPath("SweepMiddleBump", true);
      sweepAgain = Auto.getPath("SweepAgainPartnerSideBump", true);
    } catch (Exception e) {
