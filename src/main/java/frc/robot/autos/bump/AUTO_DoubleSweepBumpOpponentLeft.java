...
public class AUTO_DoubleSweepBumpOpponentLeft implements Auto {
  private final PathPlannerPath sweepHalfMiddle;
  private final PathPlannerPath sweepAgain;

  public AUTO_DoubleSweepBumpOpponentLeft() {
    try {
      sweepHalfMiddle = Auto.getPath("SweepMiddleBump", true);
      sweepAgain = Auto.getPath("SweepAgainOpponentSideBump", true);
    } catch (Exception e) {
