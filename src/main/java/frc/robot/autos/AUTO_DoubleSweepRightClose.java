...
public class AUTO_DoubleSweepRightClose implements Auto {
  ...
  public AUTO_DoubleSweepRightClose() {
    try {
      sweepHalfMiddle = Auto.getPath("SweepHalfMiddleClose", false);
      shootTrench = Auto.getPath("ShootTrenchClose", false);
